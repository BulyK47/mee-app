...
export default function App() {
  ...
  // Already resolved by the store: 'system' has been turned into the palette to paint, so every
  // consumer — this effect, and the five hueFg() call sites on the Learn and Lab screens — sees the
  // same 'dark' or 'light'. The default stays 'dark'; making 'system' the default would repaint the
  // app for every student who never opened the setting, and most phones are in light mode.
